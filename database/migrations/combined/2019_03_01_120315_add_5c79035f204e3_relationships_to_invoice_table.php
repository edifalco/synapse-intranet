...
class Add5c79035f204e3RelationshipsToInvoiceTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function down()
    {
        Schema::table('invoices', function(Blueprint $table) {
            if(Schema::hasColumn('invoices', 'user_id')) {
                $table->dropForeign('271657_5c76c94390880');
                $table->dropIndex('271657_5c76c94390880');
                $table->dropColumn('user_id');
            }
            if(Schema::hasColumn('invoices', 'project_id')) {
                $table->dropForeign('271657_5c76c943a74c8');
                $table->dropIndex('271657_5c76c943a74c8');
                $table->dropColumn('project_id');
            }
            if(Schema::hasColumn('invoices', 'expense_type_id')) {
                $table->dropForeign('271657_5c76c943ba775');
                $table->dropIndex('271657_5c76c943ba775');
                $table->dropColumn('expense_type_id');
            }
            if(Schema::hasColumn('invoices', 'meeting_id')) {
                $table->dropForeign('271657_5c76c943d0aed');
                $table->dropIndex('271657_5c76c943d0aed');
                $table->dropColumn('meeting_id');
            }
            if(Schema::hasColumn('invoices', 'contingency_id')) {
                $table->dropForeign('271657_5c76c943e4c4a');
                $table->dropIndex('271657_5c76c943e4c4a');
                $table->dropColumn('contingency_id');
            }
            if(Schema::hasColumn('invoices', 'provider_id')) {
                $table->dropForeign('271657_5c76c94404044');
                $table->dropIndex('271657_5c76c94404044');
                $table->dropColumn('provider_id');
            }
            if(Schema::hasColumn('invoices', 'service_type_id')) {
                $table->dropForeign('271657_5c76c9441c173');
                $table->dropIndex('271657_5c76c9441c173');
                $table->dropColumn('service_type_id');
            }
            if(Schema::hasColumn('invoices', 'pm_id')) {
                $table->dropForeign('271657_5c76c9443a4ed');
                $table->dropIndex('271657_5c76c9443a4ed');
                $table->dropColumn('pm_id');
            }
            if(Schema::hasColumn('invoices', 'finance_id')) {
                $table->dropForeign('271657_5c76c9445094d');
                $table->dropIndex('271657_5c76c9445094d');
                $table->dropColumn('finance_id');
            }
            if(Schema::hasColumn('invoices', 'created_by_id')) {
                $table->dropForeign('271657_5c76c9446a1fe');
                $table->dropIndex('271657_5c76c9446a1fe');

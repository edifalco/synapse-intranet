...
class Add5c78075ab457cRelationshipsToInvoiceTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function down()
    {
        Schema::table('invoices', function(Blueprint $table) {
            if(Schema::hasColumn('invoices', 'user_id')) {
                $table->dropForeign('272084_5c780714d87e5');
                $table->dropIndex('272084_5c780714d87e5');
                $table->dropColumn('user_id');
            }
            if(Schema::hasColumn('invoices', 'project_id')) {
                $table->dropForeign('272084_5c780714ecbdc');
                $table->dropIndex('272084_5c780714ecbdc');
                $table->dropColumn('project_id');
            }
            if(Schema::hasColumn('invoices', 'expense_type_id')) {
                $table->dropForeign('272084_5c7807150d714');
                $table->dropIndex('272084_5c7807150d714');
                $table->dropColumn('expense_type_id');
            }
            if(Schema::hasColumn('invoices', 'meeting_id')) {
                $table->dropForeign('272084_5c78071520ef0');
                $table->dropIndex('272084_5c78071520ef0');
                $table->dropColumn('meeting_id');
            }
            if(Schema::hasColumn('invoices', 'contingency_id')) {
                $table->dropForeign('272084_5c78071535849');
                $table->dropIndex('272084_5c78071535849');
                $table->dropColumn('contingency_id');
            }
            if(Schema::hasColumn('invoices', 'provider_id')) {
                $table->dropForeign('272084_5c780715487cb');
                $table->dropIndex('272084_5c780715487cb');
                $table->dropColumn('provider_id');
            }
            if(Schema::hasColumn('invoices', 'service_type_id')) {
                $table->dropForeign('272084_5c7807155b704');
                $table->dropIndex('272084_5c7807155b704');
                $table->dropColumn('service_type_id');
            }
            if(Schema::hasColumn('invoices', 'pm_id')) {
                $table->dropForeign('272084_5c7807156db2c');
                $table->dropIndex('272084_5c7807156db2c');
                $table->dropColumn('pm_id');
            }
            if(Schema::hasColumn('invoices', 'finance_id')) {
                $table->dropForeign('272084_5c7807158321c');
                $table->dropIndex('272084_5c7807158321c');
                $table->dropColumn('finance_id');
            }
            if(Schema::hasColumn('invoices', 'created_by_id')) {
                $table->dropForeign('272084_5c78071595d50');
                $table->dropIndex('272084_5c78071595d50');

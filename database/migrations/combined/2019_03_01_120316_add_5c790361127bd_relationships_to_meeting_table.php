...
class Add5c790361127bdRelationshipsToMeetingTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function down()
    {
        Schema::table('meetings', function(Blueprint $table) {
            if(Schema::hasColumn('meetings', 'project_id')) {
                $table->dropForeign('271666_5c76c93484f3a');
                $table->dropIndex('271666_5c76c93484f3a');
                $table->dropColumn('project_id');
            }
            if(Schema::hasColumn('meetings', 'status_id')) {
                $table->dropForeign('271666_5c7806c7717d5');
                $table->dropIndex('271666_5c7806c7717d5');
